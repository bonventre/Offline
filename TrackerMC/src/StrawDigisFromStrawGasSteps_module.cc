...
namespace mu2e {
  namespace TrackerMC {
	...
	bool createDigi(StrawElectronics const& strawele,WFXP const& xpair, SWFP const& wf, StrawId sid, StrawDigiCollection* digis,
            StrawDigiADCWaveformCollection* digiadcs);
	...
	if(createDigi(strawele,xpair,wf,sid,digis,digiadcs)){
	...
	StrawId sid, StrawDigiCollection* digis, StrawDigiADCWaveformCollection* digiadcs){
